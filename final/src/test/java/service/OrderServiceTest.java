...
//    @Test
//    public void testGetTotalRevenueByUserId() {
//        // Calculate the expected revenue based on the test data
//        double expectedRevenue = testCartItem1.getTotal() + testCartItem2.getTotal();
//
//        // Get the actual revenue from the service
//        double actualRevenue = orderService.getTotalRevenueByUserId(testUser.getId());
//
//        // Check that the actual revenue matches the expected revenue
//        assertEquals(expectedRevenue, actualRevenue, 0.001);
//    }
//
//
//    @Test
//    public void testGetTotalRevenueByUserIdWithInvalidId() {
//        double actualRevenue = orderService.getTotalRevenueByUserId(-1);
//        assertEquals(0, actualRevenue, 0.001);
//    }
}
